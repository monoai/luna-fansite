...
export const coords: [number, number][] =
  ...
  class marker_details {
    ...
    constructor( in_coords: [number, number],
...
const test_user_1 = new marker_details([20, 20], "test_user", "hello world", "./file//path");
const hillo = new marker_details([50, 50], "hillo", "Lunatan Sexy Adult Baby", "./file//path");
